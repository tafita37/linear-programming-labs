...
x1 = LpVariable ( name ="x1", lowBound =0 , cat = LpBinary )
x2 = LpVariable ( name ="x2", lowBound =0 , cat = LpBinary )
x3 = LpVariable ( name ="x3", lowBound =0 , cat = LpBinary )
x4 = LpVariable ( name ="x4", lowBound =0 , cat = LpBinary )
